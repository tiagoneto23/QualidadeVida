...
def verificar_arquivos_resultados():
    ...
    arquivos_esperados = [
        # Datasets limpos
        "/home/ubuntu/analise_pordata/GANHOMEDIOMENSAL_limpo.csv",
        "/home/ubuntu/analise_pordata/ESPERANÇADEVIDA_limpo.csv",
        "/home/ubuntu/analise_pordata/DESPESASAUDE_limpo.csv",
        "/home/ubuntu/analise_pordata/PERCEÇAODESAUDE_limpo.csv",
        "/home/ubuntu/analise_pordata/TAXADEMORTALIDADEVITAVEL_limpo.csv",
        
        # Resumos e análises
        "/home/ubuntu/analise_pordata/resumo_datasets.txt",
        "/home/ubuntu/analise_pordata/resumo_limpeza.txt",
        "/home/ubuntu/analise_pordata/resultados/dataframe_integrado.csv",
        
        # Relatório final
        "/home/ubuntu/analise_pordata/relatorio_final.md"
    ]
...
def validar_consistencia_dados():
    ...
    for arquivo in datasets_limpos:
        caminho = os.path.join("/home/ubuntu/analise_pordata", arquivo)
...
def verificar_robustez_correlacoes():
    ...
    caminho_df_integrado = "/home/ubuntu/analise_pordata/resultados/dataframe_integrado.csv"
    ...
    try:
        ...
        with open(os.path.join(diretorio_validacao, "verificacao_correlacoes.txt"), "w") as f:
            ...
            if not correlacoes_robustas:
                ...
                for col1, col2, var in correlacoes_problematicas:
                    f.write(f"  {col1} vs {col2}: {var['correlacao_original']:.4f} (variação máxima: {var['variacao_abs_max']:.4f})\n")
